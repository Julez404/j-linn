<?php /* Smarty version Smarty3rc4, created on 2019-03-18 14:07:27
         compiled from "/volume1/web/ts-interface/templates/new/chanclienteditperm.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16661933925c8f980f71c7f9-51977324%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b68f778bd11113c76fde7d70f4d517d38908c5f6' => 
    array (
      0 => '/volume1/web/ts-interface/templates/new/chanclienteditperm.tpl',
      1 => 1552910854,
    ),
  ),
  'nocache_hash' => '16661933925c8f980f71c7f9-51977324',
  'function' => 
  array (
  ),
...
<?php }?>
<form method="post" action="index.php?site=chanclienteditperm&amp;sid=<?php echo $_smarty_tpl->getVariable('sid')->value;?>
">
	<table class="border" cellpadding="1" cellspacing="0">
		<tr>
			<td class="thead" colspan="2"><?php echo $_smarty_tpl->getVariable('lang')->value['chosechanclient'];?>
</td>
		</tr>
		<tr>
			<td class="green1"><?php echo $_smarty_tpl->getVariable('lang')->value['channelid'];?>
</td>
			<td class="green1"><input type="text" name="cid" value="" /></td>
		</tr>
		<tr>
			<td class="green2"><?php echo $_smarty_tpl->getVariable('lang')->value['clientdbid'];?>
</td>
...
:</td>
			<td class="green1"><input class="button" type="submit" name="showperms" value="<?php echo $_smarty_tpl->getVariable('lang')->value['view'];?>
" /></td>
		</tr>
	</table>
</form>
<?php if (isset($_POST['cid'])&&isset($_POST['cldbid'])){?>
...
<table  class="border" cellpadding="0" cellspacing="0" style="width:100%">
	<tr>
		<td class="thead" colspan="6">(<?php echo $_POST['cid'];?>
) <?php echo $_smarty_tpl->getVariable('channelname')->value;?>
 (<?php echo $_POST['cldbid'];?>
) <?php echo $_smarty_tpl->getVariable('clientname')->value;?>
 <?php echo $_smarty_tpl->getVariable('lang')->value['permissionlist'];?>
</td>
	</tr>
	<tr>
		<td class="thead" style="width:50px">&nbsp;<a href="javascript:Klappen(0)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
.png" id="Pic0" name="<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
" border="0" alt="aus/ein-klappen" /></a></td>
		<td class="thead" style="width:45px"><?php echo $_smarty_tpl->getVariable('lang')->value['permid'];?>
</td>
		<td class="thead" style="width:410px"><?php echo $_smarty_tpl->getVariable('lang')->value['permname'];?>
</td>
		<td class="thead" style="width:50px"><?php echo $_smarty_tpl->getVariable('lang')->value['value'];?>
</td>
		<td class="thead" style="width:101px"><?php echo $_smarty_tpl->getVariable('lang')->value['options'];?>
</td>
...
" id="Lay1">
				<table style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(2)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay2">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==2){?>
				...
				<tr>
					<td class='subcat'>&nbsp;</td>
					<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(3)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay3">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==3){?>
				...
				<tr>
					<td class='subcat'>&nbsp;</td>
					<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(4)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay4">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==4){?>
				...
				<tr>
					<td class='subcat'>&nbsp;</td>
					<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(5)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay5">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==5){?>
			...
			<tr>
				<td class='maincat left' colspan="6">&nbsp;<a href="javascript:Klappen(6)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay6">
				<table style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
					<tr>
						<td class='subcat' style='width:60px'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(7)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay7">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==7){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(8)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay8">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==8){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(9)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay9">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==9){?>
			...
			<tr>
				<td class='maincat left' colspan="6">&nbsp;<a href="javascript:Klappen(10)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay10">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==10){?>
					<tr>
						...
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(11)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay11">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==11){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(12)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay12">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==12){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(13)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay13">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==13){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(14)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay14">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==14){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(15)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay15">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==15){?>
			...
			<tr class='maincat left'>
				<td colspan="6">&nbsp;<a href="javascript:Klappen(16)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay16">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==16){?>
					<tr>
						<td class='subcat' style='width:51px'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(17)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay17">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==17){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(18)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay18">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==18){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(19)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay19">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==19){?>
					...
					<tr>
						 <td class='subcat'>&nbsp;</td>
						 <td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(20)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay20">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==20){?>
			...
			<tr class='maincat left'>
				<td colspan="6">&nbsp;<a href="javascript:Klappen(21)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay21">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==21){?>
					<tr>
						<td class='subcat' style='width:51px'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(22)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay22">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==22){?>
					...
					<tr>
						 <td class='subcat'>&nbsp;</td>
						 <td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(23)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay23">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==23){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(24)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay24">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==24){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="5">&nbsp;<a href="javascript:Klappen(25)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay25">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==25){?>
			...
			<tr class='maincat left'>
				<td colspan="6">&nbsp;<a href="javascript:Klappen(26)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
